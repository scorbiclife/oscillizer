import SimpleTotalisticBoard from "../../../src/Engine/Board/SimpleBoard/SimpleTotalisticBoard.js";
import TotalisticRule from "../../../src/BaseTypes/Rule/TotalisticRule.js";
import BoundingBox from "../../../src/BaseTypes/BoundingBox.js";
...
describe("A SimpleBoard", () => {
  it("should get the cells properly", () => {
    expect(gliderBoard.getCells()).to.have.deep.members([
      [1, 0],
      [2, 1],
      [0, 2],
      [1, 2],
...
describe("A SimpleBoard", () => {
  ...
  it("should iterate the mold correctly (4 gens)", () => {
    ...
    expect(moldIterated.getCells()).to.have.deep.members(
      moldInitial.getCells()
    );
  });
});
