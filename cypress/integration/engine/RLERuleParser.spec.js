import INTRule from "../../../src/BaseTypes/Rule/INTRule.js";
import TotalisticRule from "../../../src/BaseTypes/Rule/TotalisticRule.js";
import * as RuleParser from "../../../src/Engine/RLE/RuleParser.js";
...
describe("Totalistic rule parsing", () => {
  it("should parse canonical notation correctly", () => {
    ...
    expect(RuleParser.parseTotalisticRule(conwaylifeString)).to.deep.equal(
      conwaylife
    );
  });
  ...
  it("should parse alternative notation correctly", () => {
    ...
    expect(RuleParser.parseTotalisticRule(highlifeString)).to.deep.equal(
      highlife
    );
  });
  ...
  it("should parse swapped orders correctly", () => {
    ...
    expect(RuleParser.parseTotalisticRule(lifeString)).to.deep.equal(life);
  });
  ...
  it("should fail at incorrect notation", () => {
    ...
    expect(RuleParser.parseTotalisticRule(invalidRuleString)).to.equal(
      undefined
    );
  });
});
