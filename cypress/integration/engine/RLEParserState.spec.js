import ParserState from '../../../docs/Engine/RLE/ParserState.js';

describe('RLE Parser state', () => {
  it('should process newlines correctly', () => {
    const state = new ParserState({ runCount: 10, currentCell: [0, 0] });
    state.addNewlines();
  ...
  it('should update run counts correctly', () => {
    const state = new ParserState({ runCount: 10, currentCell: [1, 2] });
