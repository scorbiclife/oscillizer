<<<<<<<< HEAD:src/Engine/Board/SimpleBoard/SimpleTotalisticBoard.js
...
>>>>>>>> parent of 4f4aee5 (Ops: Revert typescript):src/Engine/Board/SimpleBoard/SimpleTotalisticBoard.ts
